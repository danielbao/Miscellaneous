    ...
    methods
        function obj = RobotSimulator(varargin)
            ...
            for i=1:obj.N
                ...
                obj.LaserScanMessage(i) = rosmessage('sensor_msgs/LaserScan/robot_'+num2str(i));
                obj.BumperStateMessage(i) = rosmessage('std_msgs/Bool/robot_'+num2str(i));
                obj.TransformMessage(i) = rosmessage('geometry_msgs/TransformStamped/robot_'+num2str(i));
                obj.TransformMessage(i).Header.FrameId = 'map/robot_'+num2str(i);
                obj.TransformMessage(i).ChildFrameId = 'robot_base/robot_'+num2str(i);
            end          
            setupFigure(obj);
